<template>
    <div class="w-full h-full fixed bg-gray-800 text-indigo-900 pattern-grid-lg">
        ...
        <div class="w-1/3 p-12 h-fit mx-auto mt-12 bg-gray-900 rounded-xl shadow-2xl">
            ...
            <div class="w-3/4 mx-auto">
                ...
                <div class="relative mx-auto z-0 my-8">
                    <input type="number" id="age" class="block py-2.5 px-0 w-1/3 text-sm text-gray-900 bg-transparent border-0 border-b-2 rounded-xl border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer mx-auto py-4" placeholder=" " />
                ...
                <div class="relative mx-auto z-0 my-8">
                    <input type="text" id="adress" class="block py-2.5 px-2 w-2/3 text-sm text-gray-900 bg-transparent border-0 border-b-2 rounded-xl border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer mx-auto py-4" placeholder=" " />
                ...
                <div class="relative mx-auto z-0 my-8">
                    <input type="text" id="username" class="block py-2.5 px-2 w-2/3 text-sm text-gray-900 bg-transparent border-0 border-b-2 rounded-xl border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer mx-auto py-4" placeholder=" " />
                ...
                <div class="relative mx-auto z-0 my-8">
                    <input type="password" id="password" class="block py-2.5 px-2 w-2/3 text-sm text-gray-900 bg-transparent border-0 border-b-2 rounded-xl border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer mx-auto py-4" placeholder=" " />
            ...
            <div class="mx-auto flex z-0 mt-12 mb-4">
                <button class="mx-auto w-1/4 bg-violet-900 text-gray-900 p-3 font-[500] rounded-2xl shadow-lg focus:outline-none hover:bg-violet-800 hover:rounded-3xl duration-500">
                    Sign up
                </button>   
            </div>
